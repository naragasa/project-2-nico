...
> This dataset updates [pacl](https://xmarquez.github.io/democracyData/reference/pacl.html) with more countries and coverage from 1950 to 2020, as described in C. Bjørnskov and M. Rode. "Regime types and regime change: A new dataset on \< democracy, coups, and political institutions". In: *The Review of International Organizations* 15.2 (2020), pp. 531-551. [DOI: 10.1007/s11558-019-09345-1](https://link.springer.com/article/10.1007/s11558-019-09345-1). The full data and codebook can be downloaded [here](http://www.christianbjoernskov.com/bjoernskovrodedata/).
